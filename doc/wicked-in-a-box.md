...
From the offered tags, pick the newest version, e.g. `1.0.0-rc.7` (or use `latest` for the latest released build), and run
...
Options:
  -t, --tag <tag>                    wicked Docker tag to use (default: "1.0.0-rc.7")
