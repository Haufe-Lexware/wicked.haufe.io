...
From the offered tags, pick the newest version, e.g. `1.0.0-rc.1` (or use `master` for the latest build from the `master` branch, which is usually stable), and run
