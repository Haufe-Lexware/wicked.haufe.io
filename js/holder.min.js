...
!function(a, b) {
    ...
    return function(a) {
        ...
        (function(b) {
            ...
            function e(a, b) {
                for (var c = {
                    ...
                    var l=!1;
                    if (K.flags.dimensions.match(j))
                        d=!0, c.dimensions = K.flags.dimensions.output(j), l=!0;
                    else if (K.flags.fluid.match(j))
                        d=!0, c.dimensions = K.flags.fluid.output(j), c.fluid=!0, l=!0;
                    else if (K.flags.textmode.match(j))
                        c.textmode = K.flags.textmode.output(j), l=!0;
                    else if (K.flags.colors.match(j)) {
                        var m = K.flags.colors.output(j);
                        c.theme = y(c.theme, m), l=!0
                    } else if (b.themes[j])
                        b.themes.hasOwnProperty(j) && (c.theme = y(b.themes[j], null)), l=!0;
                    else if (K.flags.font.match(j))
                        c.font = K.flags.font.output(j), l=!0;
                    else if (K.flags.auto.match(j))
                        c.auto=!0, l=!0;
                    else if (K.flags.text.match(j))
                        c.text = K.flags.text.output(j), l=!0;
                    else if (K.flags.size.match(j))
                        c.size = K.flags.size.output(j), l=!0;
            ...
            function f(a) {
                ...
                if (d.font && (h.font = d.font, !o.noFontFallback && "img" === c.nodeName.toLowerCase() && K.setup.supportsCanvas && "svg" === o.renderer && (o = y(o, {
                    renderer: "canvas"
                }))), d.font && "canvas" == o.renderer && (o.reRender=!0), "background" == b)
            ...
            function h(a) {
                ...
                var d = new w({
                    width: a.width,
                    height: a.height
                }), e = d.Shape, f = new e.Rect("holderBg", {
                ...
                if (h.lineCount > 1) {
                    ...
                    j = new e.Text(a.text), k = new e.Group("line0"), k.add(j), g.add(k), g.moveTo((a.width - h.boundingBox.width) / 2, (a.height - h.boundingBox.height) / 2, null);
                return d
            }
            function i(a, b, c) {
            ...
            function q(a, b, c) {
                ...
                null == a ? (a = o("svg", F), d = o("defs", F), e = o("style", F), p(e, {
                    type: "text/css"
                }), d.appendChild(e), a.appendChild(d)) : e = a.querySelector("style"), a.webkitMatchesSelector && a.setAttribute("xmlns", F);
            ...
            var v = c(1), w = c(2), x = c(3), y = x.extend, z = x.cssProps, A = x.encodeHtmlEntity, B = x.decodeHtmlEntity, C = x.imageExists, D = x.getNodeArray, E = x.dimensionCheck, F = "http://www.w3.org/2000/svg", G = 8, H = "2.6.0", I = "\nCreated with Holder.js " + H + ".\nLearn more at http://holderjs.com\n(c) 2012-2015 Ivan Malopinsky - http://imsky.co\n", J = {
                ...
                return function(d) {
                    ...
                    if (K.setup.supportsSVG) {
                        ...
                        (null == a || a.parentNode !== document.body) && (f=!0), a = q(a, e.properties.width, e.properties.height), a.style.display = "block", f && (b = o("text", F), c = g(null), p(b, {
                            x: 0
                ...
                if (b.XMLSerializer) {
                    ...
                    return c.appendChild(d), function(b, e) {
                        ...
                        p(k, {
                            id: j
                        }), c.insertBefore(u, c.firstChild), w.appendChild(v), k.appendChild(d), k.appendChild(n), c.appendChild(k), p(d, {
                        ...
                        for (var x in l.children) {
                            ...
                            for (var A in y.children) {
                                ...
                                p(E, {
                                    x: C,
                                    y: D
                                }), G.nodeValue = B.properties.text, E.appendChild(G), n.appendChild(E)
                            }
                        }
        ...
        var b = function() {}, c = Array.prototype.slice, d = function(a, d) {
